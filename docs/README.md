...
The costs and metrics can be explored from the embedded KCP UI available on localhost.
...
```
Executing kcp with build version=0.4.0 commit=20f91961be221e7559d40a5815ff4a6a674fe662 date=2025-10-09T16:19:17Z

kcp ui is available at http://localhost:5556
```

Visit [http://localhost:5556](http://localhost:5556) in your browser.

From here you can upload the statefile generated by the discover and scan commands, and explore costs, metrics and configurations visually.
