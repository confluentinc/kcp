...
func (s *MigrationScriptsHCLService) GenerateMirrorTopicsFiles(request hclrequests.MirrorTopicsRequest) (types.MigrationScriptsTerraformProject, error) {
	if request.Mode != hclrequests.MigrateTopicsModeMirror && request.Mode != hclrequests.MigrateTopicsModeNew {
		return types.MigrationScriptsTerraformProject{}, fmt.Errorf("invalid mode: %q (values: %s, %s)", request.Mode, hclrequests.MigrateTopicsModeMirror, hclrequests.MigrateTopicsModeNew)
	}
...
func (s *MigrationScriptsHCLService) GenerateMigrateAclsFiles(request hclrequests.MigrateAclsRequest) (types.TerraformFiles, error) {
...
func (s *MigrationScriptsHCLService) GenerateMigrateSchemasFiles(request hclrequests.MigrateSchemasRequest) (types.MigrationScriptsTerraformProject, error) {
...
func (s *MigrationScriptsHCLService) GenerateMigrateGlueSchemasFiles(request hclrequests.MigrateGlueSchemasRequest) (types.MigrationScriptsTerraformProject, error) {
	ms := types.MigrationScriptsTerraformProject{}
	folders := []types.MigrationScriptsTerraformFolder{}
