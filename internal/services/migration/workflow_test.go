...
func TestWorkflow_FenceGateway_HappyPath(t *testing.T) {
	...
	gw := &mockGatewayService{
		applyGatewayYAMLFn: func(_ context.Context, _, _ string, _ []byte) (string, error) {
...
func TestWorkflow_FenceGateway_OperatorRejection_DoesNotProceed(t *testing.T) {
	waitReadyCalled := false
	gw := &mockGatewayService{
		applyGatewayYAMLFn: func(_ context.Context, _, _ string, _ []byte) (string, error) { return "", nil },
		waitForGatewayAcceptedFn: func(_ context.Context, _, _ string, _ gateway.ConditionSnapshot, _, _ time.Duration) error {
...
func TestWorkflow_SwitchGateway_HappyPath(t *testing.T) {
	var callOrder []string
	gw := &mockGatewayService{
		applyGatewayYAMLFn: func(_ context.Context, _, _ string, yaml []byte) (string, error) {
