...
func TestApacheKafkaCredentials_Validate_Valid(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_DuplicateID(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_InvalidBootstrapServer(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_NoAuthMethod(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_MultipleAuthMethods(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_EmptyClusters(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{},
	}
...
func TestApacheKafkaCredentials_Validate_MissingID(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "", // Missing ID
...
func TestApacheKafkaCredentials_Validate_EmptyBootstrapServers(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_SASLScramMissingUsername(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_SASLScramMissingPassword(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_SASLPlainValid(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_SASLPlainMissingUsername(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_SASLPlainMissingPassword(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_TLSMissingClientCert(t *testing.T) {
...
func TestApacheKafkaCredentials_Validate_TLSMissingClientKey(t *testing.T) {
	// Create temp files for testing
	tmpDir := t.TempDir()
...
func TestApacheKafkaCredentials_Validate_TLSClientCertNotFound(t *testing.T) {
	// Create temp files for testing
	tmpDir := t.TempDir()
	keyFile := filepath.Join(tmpDir, "client.key")
	require.NoError(t, os.WriteFile(keyFile, []byte("key"), 0644))
...
func TestApacheKafkaCredentials_Validate_TLSClientKeyNotFound(t *testing.T) {
	// Create temp files for testing
	tmpDir := t.TempDir()
	certFile := filepath.Join(tmpDir, "client.crt")
	require.NoError(t, os.WriteFile(certFile, []byte("cert"), 0644))
...
func TestApacheKafkaCredentials_Validate_UnauthenticatedTLS(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_UnauthenticatedPlaintext(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaClusterAuth_GetAuthMethods(t *testing.T) {
	tests := []struct {
		name            string
		clusterAuth     ApacheKafkaClusterAuth
...
func TestApacheKafkaClusterAuth_GetSelectedAuthType(t *testing.T) {
	tests := []struct {
		name          string
		clusterAuth   ApacheKafkaClusterAuth
...
func TestNewApacheKafkaCredentialsFromFile_Valid(t *testing.T) {
	content := `
clusters:
- id: prod-kafka-01
  bootstrap_servers:
...
`
	...
	creds, errs := NewApacheKafkaCredentialsFromFile(tmpFile)
...
func TestNewApacheKafkaCredentialsFromFile_FileNotFound(t *testing.T) {
	creds, errs := NewApacheKafkaCredentialsFromFile("/nonexistent/file.yaml")
	assert.Nil(t, creds)
	assert.NotEmpty(t, errs)
	assert.Len(t, errs, 1)
}

func TestNewApacheKafkaCredentialsFromFile_InvalidYAML(t *testing.T) {
...
func TestNewApacheKafkaCredentialsFromFile_ValidationFailure(t *testing.T) {
	content := `
clusters:
- id: prod-kafka-01
  bootstrap_servers:
...
func TestApacheKafkaCredentials_WriteToFile(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
				...
				Metadata: ApacheKafkaCredentialMetadata{
	...
	tmpFile := filepath.Join(t.TempDir(), "test-apache-kafka-creds.yaml")
	...
	readCreds, errs := NewApacheKafkaCredentialsFromFile(tmpFile)
	require.Empty(t, errs)
...
func TestApacheKafkaCredentials_Validate_WithMetadata(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_AllAuthMethodsDisabled(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "disabled-cluster",
...
func TestApacheKafkaCredentials_Validate_BootstrapServerEdgeCases(t *testing.T) {
	tests := []struct {
		name   string
		server string
		valid  bool
...
func TestApacheKafkaCredentials_Validate_ValidJolokiaConfig(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_JolokiaMissingEndpoints(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_JolokiaWithAuth(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_JolokiaWithTLS(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_JolokiaWithAuthAndTLS(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_JolokiaAuthMissingPassword(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_ValidPrometheusConfig(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_PrometheusWithAuth(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_PrometheusWithTLS(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_PrometheusWithAuthAndTLS(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_PrometheusMissingURL(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_Validate_PrometheusAuthMissingPassword(t *testing.T) {
	creds := &ApacheKafkaCredentials{
		Clusters: []ApacheKafkaClusterAuth{
			{
				ID:               "prod-kafka-01",
...
func TestApacheKafkaCredentials_HasPrometheusConfig(t *testing.T) {
	tests := []struct {
		name        string
		clusterAuth ApacheKafkaClusterAuth
		expected    bool
...
func TestApacheKafkaCredentials_HasJolokiaConfig(t *testing.T) {
	tests := []struct {
		name        string
		clusterAuth ApacheKafkaClusterAuth
		expected    bool
