...
// ApacheKafkaCredentials represents the apache-kafka-credentials.yaml file
type ApacheKafkaCredentials struct {
	Clusters []ApacheKafkaClusterAuth `yaml:"clusters"`
}

// ApacheKafkaClusterAuth contains authentication details for a single Apache Kafka cluster
type ApacheKafkaClusterAuth struct {
	ID                    string                        `yaml:"id"`
	...
	Metadata              ApacheKafkaCredentialMetadata `yaml:"metadata,omitempty"`
	Jolokia               *JolokiaConfig                `yaml:"jolokia,omitempty"`
	Prometheus            *PrometheusConfig             `yaml:"prometheus,omitempty"`
}

// ApacheKafkaCredentialMetadata allows users to add optional organizational metadata
type ApacheKafkaCredentialMetadata struct {
...
// NewApacheKafkaCredentialsFromFile loads Apache Kafka credentials from a YAML file
func NewApacheKafkaCredentialsFromFile(credentialsYamlPath string) (*ApacheKafkaCredentials, []error) {
	...
	var credsFile ApacheKafkaCredentials
...
func (c ApacheKafkaCredentials) Validate() (bool, []error) {
	errs := []error{}
...
func (c ApacheKafkaClusterAuth) GetAuthMethods() []AuthType {
	...
	// Note: IAM not supported for Apache Kafka

	return enabledMethods
}

// GetSelectedAuthType returns the selected auth type for the cluster
func (c ApacheKafkaClusterAuth) GetSelectedAuthType() (AuthType, error) {
...
func (c ApacheKafkaClusterAuth) HasJolokiaConfig() bool {
	return c.Jolokia != nil
}

// HasPrometheusConfig returns true if the cluster has Prometheus configuration
func (c ApacheKafkaClusterAuth) HasPrometheusConfig() bool {
	return c.Prometheus != nil
}

// WriteToFile writes the credentials to a YAML file
func (c *ApacheKafkaCredentials) WriteToFile(filePath string) error {
