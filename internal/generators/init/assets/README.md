# kcp Migration CLI - Getting Started Guide
...
**Output:**
The command creates a `migration-scripts` directory containing shell scripts:
...
> [!NOTE]
> A `README.md` is generated in the `migration-scripts` directory to further assist in migrating the data from MSK to Confluent Cloud.
