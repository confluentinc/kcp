...
module "confluent_platform_broker_instances" {
  ...
  confluent_cloud_cluster_key                = module.confluent_cloud.confluent_cloud_cluster_key
  confluent_cloud_cluster_secret             = module.confluent_cloud.confluent_cloud_cluster_secret
