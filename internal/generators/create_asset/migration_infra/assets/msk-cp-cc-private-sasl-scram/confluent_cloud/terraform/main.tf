...
data "confluent_schema_registry_cluster" "terrasnap_schema_registry" {
  environment {
    id = confluent_environment.environment.id
  }
...
resource "confluent_api_key" "env-manager-schema-registry-api-key" {
  ...
  managed_resource {
    id          = data.confluent_schema_registry_cluster.terrasnap_schema_registry.id
    api_version = data.confluent_schema_registry_cluster.terrasnap_schema_registry.api_version
    kind        = data.confluent_schema_registry_cluster.terrasnap_schema_registry.kind
...
resource "confluent_role_binding" "subject-resource-owner" {
  ...
  crn_pattern = "${data.confluent_schema_registry_cluster.terrasnap_schema_registry.resource_name}/subject=*"
}
