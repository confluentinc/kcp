...
FLAG                     | ENV_VAR
-------------------------|---------------------------
--cluster-file           | CLUSTER_FILE=path/to/cluster_scan.json
...
`,
	...
	aclsCmd.Flags().StringVar(&clusterFile, "cluster-file", "", "The cluster scan JSON file generated by the 'kcp scan cluster' command")
