...
SCENARIOS=("baseline" "pause-sync-happy" "pause-sync-refuses" "pause-sync-restores-filters" "pause-sync-rogue" "pause-sync-drift" "batch" "rogue-producer" "rogue-producer-false-positive")
