...
The command writes a ` + "`discovered_clients`" + ` array to the cluster's entry in the state file. Each entry is a unique combination of ` + "`clientID + topic + role + auth + principal`" + `, e.g.:
