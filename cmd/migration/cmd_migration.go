...
func NewMigrationCmd() *cobra.Command {
	migrationCmd := &cobra.Command{
		Use:   "migration",
		Short: "Commands for gateway migration using CPC Gateway.",
		Long: `Execute the gateway migration phase for Confluent Cloud using the Confluent Platform Connect (CPC) Gateway.
...
3. **Fence Gateway** — apply the fenced gateway CR to block traffic during migration.
