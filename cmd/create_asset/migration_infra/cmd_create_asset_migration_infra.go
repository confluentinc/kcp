...
func NewMigrationInfraCmd() *cobra.Command {
	...
	typeSixFlags.StringVar(&jumpClusterInstanceType, "jump-cluster-instance-type", "", "[Optional] The instance type to use for the jump cluster. (default: MSK broker type).")
