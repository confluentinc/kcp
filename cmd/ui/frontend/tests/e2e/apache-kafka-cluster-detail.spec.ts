...
test.describe('Apache Kafka Cluster Detail View', () => {
  test.beforeEach(async ({ page }) => {
    ...
    // Navigate to Apache Kafka cluster
    await page.click('text=prod-kafka-cluster')
  })

  test('displays correct tabs for Apache Kafka cluster', async ({ page }) => {
    // Verify Apache Kafka-specific tabs are present
    ...
    // Verify Metrics tab is present (Apache Kafka supports Jolokia/Prometheus metrics)
