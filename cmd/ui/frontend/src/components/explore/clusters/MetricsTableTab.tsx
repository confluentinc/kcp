        ...
        <div className="w-full overflow-hidden rounded-lg">
          <div className="overflow-x-auto max-h-96 overflow-y-auto">
            <Table className="min-w-full">
              <TableHeader>
                <TableRow>
                  <TableHead className="sticky left-0 bg-card z-10 w-[200px] max-w-[200px] border-r border-border">
                    Metric
                  </TableHead>
                  <TableHead className="text-center w-[100px] min-w-[100px] max-w-[100px] border-r border-border">
              ...
              <TableBody>
                {processedData.tableData.map((row, rowIndex) => {
                  ...
                  return (
                    ...
                    >
                      <TableCell className="sticky left-0 bg-card z-10 font-medium border-r border-border w-[200px] max-w-[200px]">
                        <div
                      ...
                      {/* Min column */}
                      <TableCell className="text-center border-r border-border w-[100px] min-w-[100px] max-w-[100px]">
