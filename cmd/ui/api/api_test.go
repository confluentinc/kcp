...
func (m *mockReportService) FilterConnectMetrics(processedState types.ProcessedState, clusterID string, startTime, endTime *time.Time) (*types.ProcessedClusterMetrics, error) {
	return nil, nil
}
