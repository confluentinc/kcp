...
func (m *mockReportService) FilterConnectMetrics(processedState report.ProcessedState, clusterID, sourceType, connectRestURL, connectorName string, startTime, endTime *time.Time) (*types.ConnectClusterMetrics, error) {
